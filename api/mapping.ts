...
export const stakePoolMetadatas: StakePoolMetadata[] = [
  ...
  // },
  {
    ...
    hostname:'stake.punkedducks.com',
    nameInHeader: true,
    stakePoolAddress: new PublicKey(
      'AxHiaxZeoDsyjD8Eyj5tQtrajkxYk5xebEK1QNQ1LSE7'
    ),
    websiteUrl: 'https://solscan.io/token/3vaySGGghUAeVBxqFZkgvp9Fm33pcNcucrK9BhXUnK98',
    receiptType: ReceiptType.Original,
    maxStaked: 1000,
    imageUrl: 'https://www.arweave.net/DWKkkbbOi5x6MJhgulQ6FwcXh-emrcaqg8cjTx5j0PI?ext=png',
