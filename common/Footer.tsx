...
export const SOCIALS = {
  discord: { icon: <FaDiscord />, link: 'https://discord.gg/xbDCUaJUgh' },
  twitter: { icon: <FaTwitter />, link: 'https://twitter.com/PunkedDucks' },
}
      ...
      <div className="flex w-full flex-wrap items-start justify-between gap-10 py-10">
        ...
        <div className="flex gap-10 self-end text-center md:gap-20">
          ...
          <span className="flex flex-col items-start gap-1">
            ...
            <a href="https://duckzwitattitudes.com/whitepaper.html" className="text-gray-400">
              Documentation
            </a>
            <a
            ...
            <a href="mailto:duckzwitattitudes@gmail.com" className="text-gray-400">
              Contact
            </a>
