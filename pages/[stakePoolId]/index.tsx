...
function StakePoolHome() {
  ...
  return (
    ...
    >
      <Head>
        <title>{'D.W.A | StakePool'}</title>
        <meta name="description" content="Bweed" />
              ...
              <div className="flex gap-5">
                <Tooltip title="Click on tokens to select them">
                  ...
                  >
                    ...
                    <span className="my-auto" style={{color:'#000000'}}>
                ...
                <Tooltip title="Attempt to stake all tokens at once">
                  ...
                  >
                    <span className="my-auto" style={{color:'#000000'}}>Select All</span>
                  </button>
                </Tooltip>
              </div>
            </div>
