...
export const ENVIRONMENTS: Environment[] = [
  {
    label: 'mainnet-beta',
    primary: process.env.MAINNET_PRIMARY || 'https://little-chaotic-meadow.solana-mainnet.discover.quiknode.pro/dd42266529740e8f5c627cc0c59b0cfa746a38d7/',
    secondary: process.env.MAINNET_SECONDARY || 'https://little-chaotic-meadow.solana-mainnet.discover.quiknode.pro/dd42266529740e8f5c627cc0c59b0cfa746a38d7/',
  },
  {
    label: 'testnet',
